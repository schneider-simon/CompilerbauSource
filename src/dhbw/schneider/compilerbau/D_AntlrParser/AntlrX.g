...
@parser::header {package de.dhbw.compiler.xantlrparser;}
@lexer::header  {package de.dhbw.compiler.xantlrparser;}
...
@lexer::members {
 ...
 public Token emit() {
    ...
    switch(state.type) {
      case INT: t.intValue = intValue; break;
      case FLOAT: t.floatValue = cardinalValue+(fractionValue/Math.pow(10,fractionLength))*Math.pow(10,exponentSign*exponentValue); break;
